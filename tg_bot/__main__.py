    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(DEVIL_IMG,PM_START_TEXT.format(escape_markdown(first_name), escape_markdown(bot.first_name), OWNER_NAME, OWNER_USERNAME ),reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="Creater",url="https://t.me/kpsabith"),InlineKeyboardButton(text="Group",url="https://t.me/FMmovierequst")]]),disable_web_page_preview=True, parse_mode=ParseMode.MARKDOWN)
    else:
         

        update.effective_message.reply_text("Heya, How can I help you? 🙂",reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="❓ Help",url="t.me/{}?start=help".format(bot.username)),InlineKeyboardButton(text=" Group",url="https://t.me/FMmovierequst")]]))
